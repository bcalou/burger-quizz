const nuggets = [
  {
    question: {
      text:
        "Combien de temps pour rallier Châteaurenaud à pied, depuis la statue Carnot d'Angoulême ?",
    },
    answers: {
      a: {
        text: '9h 12min',
  ...
  },
  {
    question: {
      text:
        'Combien de kilogrammes de fromage sont produits en France chaque seconde ?',
    },
    answers: {
      a: {
        text: '53,7',
